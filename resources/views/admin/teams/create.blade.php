                  ...
                  <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                          <h3 class="card-title">Nuevo Integrante</h3>
                        </div>

                        <div class="card-body"> 

                            {!! Form::open(['route'=>'teams.store', 'autocomplete'=>'off', 'files'=>true]) !!}
                                ...
                                {!! Form::submit('Crear Integrante', ['class'=>'btn btn-primary btn-block']) !!}
