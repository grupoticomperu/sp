@extends('admin.layout')
    @section('header')
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Ofrecemos </h1>
                <a href="{{ route('offers.create')}}" class="btn btn-primary pull-right"><i class="fa fa-plus"> </i> Crear lo que Ofrecemos</a>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">inicio</a></li>
                <li class="breadcrumb-item active">Ofrecemos</li>
                </ol>
            </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                  ...
                  @foreach ($offers as $offer)
                      <tr>
                          ...
                          <td>
                            ...
                            <a href="{{ route('offers.edit', $offer)}}" class="btn btn-xs btn-info"><i class="fas fa-pencil-alt"></i></a> 
                            {{-- <a class="btn btn-primary btn-sm" href="{{route('admin.posts.edit', $post)}}">Editar</a> --}}
  
                            <button data-toggle="modal" data-target="#deleteModal" data-id="{{ $offer->id }}"
